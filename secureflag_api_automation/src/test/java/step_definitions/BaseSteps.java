...
public class BaseSteps {
    ...
    String baseUrl, getUrl, postUrl,  createBookingPayloadPath;

    public BaseSteps() {
        baseUrl = "http://localhost:8080/v1";
        getUrl = baseUrl + "/events";
        postUrl = baseUrl + "/bookings";
        createBookingPayloadPath = "/templates/CreateBookingTemplate.json";
    }
